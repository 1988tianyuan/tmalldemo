...
public class ForeController {
    ...
    public String immeBuy(OrderItem orderItem, HttpSession session, Model model){
        int oiid;
        User user = (User) session.getAttribute("user");
        int uid = user.getId();
        orderItem.setUid(uid);
        OrderItem orderItemExist = orderItemService.listByUidAndPid(uid, orderItem.getPid());
    ...
    public String comfirmBuy(String[]oiid, Model model){
